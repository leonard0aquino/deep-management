...
const client: Client = { id: "c1", name: "Acme", segment: null, logo_url: null, contract_value: 1000, contract_renewal_date: "2026-12-01", owner_manager_id: "m1", client_kind: "customer", active: true, custom_fields: {}, created_at: "2026-07-01" };
const interaction: InteractionView = { id: "i1", client_id: "c1", client_name: "Acme", product_id: "p1", product_name: "Produto", product_color: null, manager_id: "m1", manager_name: "Ana", contact_id: null, contact_name: null, interaction_type: "meeting", topic: "Revisão", notes: "Notas", decisions: "Aprovado", customer_sentiment: null, risks: null, opportunities: null, next_step: "Enviar proposta", next_step_owner: "Ana", next_step_due_date: "2026-08-01", additional_participants: [], confidential: false, business_area: "customer_success", counts_for_health: true, relevance: 4, occurred_at: "2026-07-28", links: [], created_by: "u1", created_at: "2026-07-28T12:00:00Z", updated_at: "2026-07-28T12:00:00Z", days_since_contact: 0, status: "recente" };
...
const clientProductOwner: ClientProductOwner = { id: "owner1", client_product_id: "link1", manager_id: "m1", active: true, created_at: "2026-07-01", updated_at: "2026-07-28" };

const completeInput = { client, interactions: [interaction], stakeholders: [stakeholder], successPlans: [successPlan], tasks: [task], commercialPlans: [commercialPlan], clientProducts: [clientProduct], clientProductOwners: [clientProductOwner], referenceDate: "2026-07-28", staleAfterDays: 90 };
