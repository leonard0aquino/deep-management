...
const client: Client = { id: "c1", name: "Acme", segment: null, logo_url: null, contract_value: 1000, contract_renewal_date: "2026-08-20", owner_manager_id: null, client_kind: "customer", active: true, custom_fields: {}, created_at: "2026-01-01" };
