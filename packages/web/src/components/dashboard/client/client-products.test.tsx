...
import type { ClientProduct, DeepManager, Product } from "@/lib/types/database";
...
describe("ClientProducts", () => {
  it("exibe responsáveis distintos e produtos ainda sem histórico", () => {
    render(<ClientProducts assignments={assignments} rows={[]} products={products} managers={managers} canManage={false} />);
