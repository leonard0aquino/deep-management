...
export default async function CommercialOpportunitiesPage() {
  ...
  const [opportunities, events, clients, contacts, products, managers, profiles] = await Promise.all([
